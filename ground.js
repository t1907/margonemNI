(function() {
  $(`<style>
    ...
    .gargonem-window {color: #000000 !important; background: #101010; border-radius: 0px !important; box-shadow: 0 0 0 1px #000, 0 0 0 2px #5a4b41	, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important;}
    
    .cll-alert-content{background: #101010 !important;color: #f5f5f5 !important;}
    .cll-alert{border: 1px solid #5a4b41	 !important; box-shadow: 0 0 0 1px #5a4b41	 !important; background: #101010 !important; color: #f5f5f5 !important;}
    .cll-alert button{background: #101010 !important; border: 1px solid #5a4b41	 !important; box-shadow: 0 0 0 1px #101010 !important;}
    ...
    .chat-configure-window .chat-option-header {color: #f5f5f5 !important; border: 1px solid #5a4b41	 !important; background: #101010 !important;}
    ...
    .world-window__info, .info-box, .salvage__info, .enhance__info, .extraction__info{border: 1px solid #5a4b41	 !important; background: #101010 !important;}
    .hunting-statistics-table td, .hunting-statistics-table-header td {border: 1px solid #5a4b41	 !important; background: #101010;}
    .players-online__item, .server-parameters__item .location-parameters__item{border: 1px solid #5a4b41	 !important; background: #101010;}
    ...
    .battle-controller .graphics .battle-border {border-image: url("https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/window-frame.png") 32 20 fill repeat; background-size: 100% 100%;}
    ...
    .additional-skill-panel .graphics .additional-skill-panel-border {border-image: url("https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/window-frame.png")  32 20 fill repeat; background-size: 100% 100%;}
    ...
    .ni-input input.default {border: 1px solid #5a4b41	; background: #101010; color: #f5f5f5; box-shadow: none; border-radius: 0px;}
    input.default {border: 1px solid #5a4b41	; background: #101010; color: #f5f5f5; box-shadow: none; border-radius: 0px;}

    .loot-window .items-wrapper .loot-item-wrapper{box-shadow: 0px 0px 0px 1px #5a4b41	; border: 1px solid #5a4b41	00;}
    ...
    .popup-menu, .mAlert-layer .scroll-wrapper.menu-wrapper {border-radius: 1px; background-color: #101010; box-shadow: 0 0 0 1px #5a4b41	;}
    .popup-menu .menu-item, .mAlert-layer .scroll-wrapper.menu-wrapper .wrapper .bck-wrapper .option {background: #101010; border: 1px solid #5a4b41	; border-radius: 1px;}
    ...
    .button.mz-widget, .widget-button.mz-widget {background: linear-gradient(to top, #101010, #101010); box-shadow: inset 0 0 1px 1px #5a4b41	, inset 0 0 0 3px #101010;}
    .button.mz-widget:before, .widget-button.mz-widget:before {box-shadow: inset 0 0 0px 1px #5a4b41	, inset 0 0 0 3px #101010;}

    .button, .widget-button, .button.green, .widget-button.green {background-image: linear-gradient(to top, #101010, #101010)!important;box-shadow: inset 0 0 1px 1px #5a4b41	, inset 0 0 0 3px #101010!important;}
    ...
    .interface-element-middle-1-background {border-image: url("https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/middle_graphics.png") 0 11 fill round; background: #101010;}
    .interface-element-middle-2-background {border-image: url("https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/middle_graphics.png") 0 11 fill round; background: #101010;}
    .interface-element-middle-3-background {border-image: url("https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/middle_graphics.png") 0 11 fill round; background: #101010;}
    .interface-element-middle-4-background {border-image: url("https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/middle_graphics.png") 0 11 fill round; background: #101010;}

    .interface-element-middle-1-background-stretch{border-image: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/middle_graphics.png) 0 11 fill round; background: #101010;}
    .interface-element-middle-2-background-stretch{border-image: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/middle_graphics.png) 0 11 fill round; background: #101010;}
    .interface-element-middle-3-background-stretch{border-image: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/middle_graphics.png) 0 11 fill round; background: #101010;}
    ...
    .shop-wrapper .shop-background .paper-1,.shop-wrapper .shop-background .paper-2 {background: #101010; box-shadow: inset 0 0 1px 0 #5a4b41	;}
    ...
    .tip-wrapper {box-shadow: 0px 0px 1px 1px #5a4b41	; color: #f5f5f5;}
    ...
    .tip-wrapper[data-type=t_item] .item-head {background: #101010; border: 1px solid #5a4b41	;}
    .tip-wrapper[data-type=t_item] .item-head .item-builds,.tip-wrapper[data-type=t_item] .item-head .item-type {color: #f5f5f5;}
    .tip-wrapper[data-type=t_item] .item-tip-section {border-bottom: 1px solid #5a4b41	00;}
    ...
    .tip-wrapper[data-item-type=normal],.tip-wrapper[data-item-type=t-norm] {box-shadow: 0px 0px 3px 1px #5a4b41	;}
    </style>`).appendTo('head');
  }
)();