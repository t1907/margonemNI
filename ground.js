(function() {
  $(`<style> 
     ...
     .gargonem-window {color: #000000 !important; background: #1e140f; border-radius: 0px !important; box-shadow: 0 0 0 1px #000, 0 0 0 2px #5a4b41, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important;}

     .cll-alert-content{background: #1e140f !important;color: #f5f5f5 !important;}
     .cll-alert{border: 1px solid #5a4b41 !important; box-shadow: 0 0 0 1px #5a4b41 !important; background: #1e140f !important; color: #f5f5f5 !important;}
     .cll-alert button{background: #1e140f !important; border: 1px solid #5a4b41 !important; box-shadow: 0 0 0 1px #1e140f !important;}
     ...
     body {font-family: 'MedievalSharp';}
     ...
     .mails-window .mail-column .scroll-wrapper .scroll-pane .one-mail-wraper {background: #1e140f;}

     .chat-channel-card-wrapper{border: 1px solid #5a4b41 !important;}
     .new-chat-window .chat-message-wrapper, .chat-input-wrapper .magic-input-wrapper, .chat-input-wrapper .control-wrapper .menu-card, .chat-input-wrapper .control-wrapper .chat-config-wrapper {border: 1px solid #5a4b41 !important;}
     .chat-input-wrapper {background: #1e140f !important;}
     .new-chat-window {background: #1e140f !important;}
     .chat-configure-window .chat-option-header {color: #f5f5f5 !important; border: 1px solid #5a4b41 !important; background: #1e140f !important;}
     ...
     .interface-element-background-color-1 {background: #1e140f;}
     .interface-element-background-color-2 {background: #1e140f;}
     .interface-element-background-color-3 {background: #1e140f;}
     ...
     .layer.interface-layer .main-column{background: #1e140f !important;}
     ...
     .layer.interface-layer .positioner.bottom .bg-additional-widget-left {background: #1e140f;}
     .layer.interface-layer .positioner.bottom .bg-additional-widget-right {background: #1e140f;}
     ...
     .drop-down-menu-section .type-header {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/auctions/header_left.png);}

     .battle-controller .graphics .header-graphic {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/battle-panel-header.png);}
     .battle-controller .graphics .middle-graphic {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/battle-panel-middle.png) repeat;}
     .battle-controller .skill-hider {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/skill-hider.png);}
     .battle-controller .graphics .bottom-graphic {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/skill_hot_skills.png) 0 -35px;}
     ...
     .interface-element-grid-border {outline: 1px solid #1e140f; box-shadow: 0 0 0 1px #404040;}
     ...
     .ni-input input.default {border: 1px solid #5a4b41; background: #1e140f; color: #f5f5f5; box-shadow: none; border-radius: 0px;}
     input.default {border: 1px solid #5a4b41; background: #1e140f; color: #f5f5f5; box-shadow: none; border-radius: 0px;}

     .loot-window .items-wrapper .loot-item-wrapper{box-shadow: 0px 0px 0px 1px #5a4b41; border: 1px solid #5a4b4100;}
     .loot-window .items-wrapper .loot-item-wrapper .slot {border: 1px solid #5a4b41;}
     .loot-window .items-wrapper .loot-item-wrapper .text-info {border-top: 1px solid #1e140f;border-bottom: 1px solid #1e140f;}

     .tw-list-item{background: #1e140f !important;}
     .border-window.transparent .border-image{box-shadow: 0 0 0 1px #000, 0 0 0 2px #5a4b41, 0 0 0 3px #000000, 2px 2px 3px 3px #000; border-radius: 0px;}

     .loot-window .button-holder .button{background:linear-gradient(to top, #1e140f, #1e140f)}
     .loot-window .button-holder .button:before{box-shadow:inset 0 0 1px 1px #1e140f}
     .loot-window .button-holder .button.want{background:linear-gradient(to top,#1e140f,#1e140f)}
     .loot-window .button-holder .button.want:before{box-shadow:inset 0 0 1px 1px #1e140f}
     .loot-window .button-holder .button.not{background:linear-gradient(to top, #1e140f, #1e140f)}
     .loot-window .button-holder .button.not:before{box-shadow:inset 0 0 1px 1px #1e140f}
     .loot-window .button-holder .button.must{background:linear-gradient(to top, #1e140f, #1e140f)}
     .loot-window .items-wrapper .loot-item-wrapper .button-holder .button.green{border-color: #1e140f;}
     ...
     .trade-window .content .hero-show-item, .trade-window .content .other-watch-item {background: #1e140f;}
     ...
     .button.mz-widget:before, .widget-button.mz-widget:before {box-shadow: inset 0 0 0px 1px #5a4b41, inset 0 0 0 3px #1e140f;}

     .button, .widget-button, .button.green, .widget-button.green {background-image: linear-gradient(to top, #1e140f, #1e140f)!important;box-shadow: inset 0 0 1px 1px #5a4b41, inset 0 0 0 3px #1e140f!important;}
     .button.red, .widget-button.red  {background-image: linear-gradient(to top, #1e140f, #1e140f)!important;box-shadow: inset 0 0 1px 1px #ff4040, inset 0 0 0 3px #1e140f !important;}
     ...
     .button.black,.button:not(.no-hover):not(.disabled):hover:not(.active),.widget-button.black,.widget-button:not(.no-hover):not(.disabled):hover:not(.active),.button.small.green.pressed {
         background-image: linear-gradient(to top, #1e140f,#1e140f)!important; box-shadow: inset 0 0 1px 1px #ff4040, inset 0 0 0 3px #1e140f !important;
     }

     .button.black:before,.button:not(.no-hover):not(.disabled):hover:not(.active):before,.widget-button.black:before,.widget-button:not(.no-hover):not(.disabled):hover:not(.active):before {box-shadow: inset 0 0 1px 1px #1e140f !important;}
     .button.black.active:before,.button:not(.no-hover):not(.disabled):hover:not(.active).active:before,.widget-button.black.active:before,.widget-button:not(.no-hover):not(.disabled):hover:not(.active).active:before {box-shadow: inset 0 0 1px 1px #1e140f !important;}
     .button.green.window-is-open::before, .widget-button.green.window-is-open::before {background-color: #1e140f !important;}
     .button.red::before, .widget-button.red::before{box-shadow: inset 0 0 1px 1px #1e140f !important;}
     .button.ground::before, .button.violet::before, .widget-button.ground::before, .widget-button.violet::before{box-shadow: inset 0 0 1px 1px #1e140f !important;}
     .button.blink-violet::before, .widget-button.blink-violet::before{box-shadow: inset 0 0 1px 1px #1e140f !important;}
     .button::before, .widget-button::before, .button.green::before, .widget-button.green::before{box-shadow: inset 0 0 1px 1px #1e140f;}
     .button, .widget-button {border-radius: 0px !important;}
     .button, .widget-button::after {border-radius: 0px !important; box-shadow: 0 2px 0 1px #1e140f}
     .widget-button .widget-blink{display: none !important;}
     
     .content .loot-window .items-wrapper .loot-item-wrapper .button-holder .button.green:not(.pressed){border-color: #1e140f; box-shadow:inset 0 0 1px 1px #40ff40 !important;}
     ...
     .interface-element-green-box-background {background: #1e140f;}
     .interface-element-green-box-background-stretch {background: #1e140f;}
     ...
     .layer.interface-layer .positioner.top .hud-container {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png) -7px 0;}
     .bottom-panel {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png) -6px -73px no-repeat}
     .bottom-panel.end-game {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png) -6px -354px no-repeat}
     .bottom-panel .glass {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png) -8px -199px;}
     .bottom-panel .exp-bar-wrapper .exp-progress .overlay {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png) no-repeat -123px -184px;}
     .bottom-panel .exp-bar-wrapper .exp-progress.left .ribbon.end-game-ribbon,.bottom-panel .exp-bar-wrapper .exp-progress.right .ribbon.end-game-ribbon {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png)}
     .bottom-panel .battle-bars-wrapper .battle-bar .background {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png) -404px -199px}
     .bottom-panel .battle-bars-wrapper .battle-bar .overlay {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/sprite.png) -409px -186px;}

     .bottom-panel-pointer-bg {background: url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/ground/extInterface.png);}
     ...
     .shop-wrapper .shop-background .paper-1,.shop-wrapper .shop-background .paper-2 {background: #1e140f; box-shadow: inset 0 0 1px 0 #5a4b41;}
     
     .card-content .clan-list-find-panel input.default,.card-content .green-box input.default {border: 1px solid #5a4b41;}
     ...
     .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table {border-right: 1px solid #5a4b41; border-left: 1px solid #5a4b41; border-bottom: 1px solid #5a4b41;}
     ...
     .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table tr td {border-right: 1px solid #5a4b41; border-left: 1px solid #5a4b41; border-bottom: 1px solid #5a4b41;}
...
.tip-wrapper .content .info-wrapper .nick {background: #303030; border: 1px solid #5a4b41;}
...
.tip-wrapper[data-item-type=t-upgraded],.tip-wrapper[data-item-type=upgraded] {box-shadow: 0px 0px 1px 1px #ffff00;}

.tip-wrapper[data-item-type=elite],.tip-wrapper[data-item-type=t-elite],.tip-wrapper[data-item-type=t-uniupg],.tip-wrapper[data-item-type=unique] {box-shadow:  0px 0px 1px 1px #daa520;}

.tip-wrapper[data-item-type=legendary],.tip-wrapper[data-item-type=t-leg] {box-shadow: 0px 0px 1px 1px #cc0099;}
