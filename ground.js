(function() {
  $(`<style>
    ...
    .gargonem-window {color: #000000 !important; background: #101010; border-radius: 0px !important; box-shadow: 0 0 0 1px #000, 0 0 0 2px #3b2e1a, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important;}
    
    .cll-alert-content{background: #101010 !important;color: #f5f5f5 !important;}
    .cll-alert{border: 1px solid #3b2e1a !important; box-shadow: 0 0 0 1px #3b2e1a !important; background: #101010 !important; color: #f5f5f5 !important;}
    .cll-alert button{background: #101010 !important; border: 1px solid #3b2e1a !important; box-shadow: 0 0 0 1px #101010 !important;}
    ...
    .game-window-positioner .character_wrapper .stats-wrapper .header-title{background: #3b2e1a !important; border-bottom: 1px solid #3b2e1a !important;}
    ...
    .chat-channel-card-wrapper{border: 1px solid #3b2e1a !important;}
    .new-chat-window .chat-message-wrapper, .chat-input-wrapper .magic-input-wrapper, .chat-input-wrapper .control-wrapper .menu-card, .chat-input-wrapper .control-wrapper .chat-config-wrapper {border: 1px solid #3b2e1a !important;}
    .chat-input-wrapper {background: #101010 !important;}
    .new-chat-window {background: #101010 !important;}
    .chat-configure-window .chat-option-header {color: #f5f5f5 !important; border: 1px solid #3b2e1a !important; background: #101010 !important;}
    ...
    .world-window__info, .info-box, .salvage__info, .enhance__info, .extraction__info{border: 1px solid #3b2e1a !important; background: #101010 !important;}
    .hunting-statistics-table td, .hunting-statistics-table-header td {border: 1px solid #3b2e1a !important; background: #101010;}
    .players-online__item, .server-parameters__item .location-parameters__item{border: 1px solid #3b2e1a !important; background: #101010;}
    ...
    .ni-input input.default {border: 1px solid #3b2e1a; background: #101010; color: #f5f5f5; box-shadow: none; border-radius: 0px;}
    input.default {border: 1px solid #3b2e1a; background: #101010; color: #f5f5f5; box-shadow: none; border-radius: 0px;}

    .loot-window .items-wrapper .loot-item-wrapper{box-shadow: 0px 0px 0px 1px #3b2e1a; border: 1px solid #3b2e1a00;}
    .loot-window .items-wrapper .loot-item-wrapper .slot {border: 1px solid #3b2e1a;}
    ...
    .border-window.transparent .border-image, .dialogue-window .border-image{box-shadow: 0 0 0 1px #3b2e1a; border-radius: 0px;}
    ...
    .interface-element-one-item-slot-2 {border: 1px solid #3b2e1a;outline: 2px solid #101010; background: #101010; box-shadow: inset 2px 0 15px 1px #000;}
    ...
    .interface-element-box-shadow-1 {box-shadow: inset 0 0 5px 0 #3b2e1a;} 

    .popup-menu, .mAlert-layer .scroll-wrapper.menu-wrapper {border-radius: 1px; background-color: #101010; box-shadow: 0 0 0 1px #3b2e1a;}
    .popup-menu .menu-item, .mAlert-layer .scroll-wrapper.menu-wrapper .wrapper .bck-wrapper .option {background: #101010; border: 1px solid #3b2e1a; border-radius: 1px;}
    .popup-menu .menu-item:hover:not(.label):not(.disabled):not(.cooldown-disabled):not(.one-step-skill-menu), .mAlert-layer .scroll-wrapper.menu-wrapper .wrapper .bck-wrapper .option:hover:not(.disabled) {background-color: #3b2e1a;}
    ...
    .popup-menu .menu-item.one-step-skill-menu:not(.disabled):hover {background-color: #3b2e1a;}

    .button.mz-widget, .widget-button.mz-widget {background: linear-gradient(to top, #101010, #101010); box-shadow: inset 0 0 1px 1px #3b2e1a, inset 0 0 0 3px #101010;}
    .button.mz-widget:before, .widget-button.mz-widget:before {box-shadow: inset 0 0 0px 1px #3b2e1a, inset 0 0 0 3px #101010;}

    .button, .widget-button, .button.green, .widget-button.green {background-image: linear-gradient(to top, #101010, #101010)!important;box-shadow: inset 0 0 1px 1px #3b2e1a, inset 0 0 0 3px #101010!important;}
    ...
    .shop-wrapper .shop-background .paper-1,.shop-wrapper .shop-background .paper-2 {background: #101010; box-shadow: inset 0 0 1px 0 #3b2e1a;}

    .card-content .clan-list-find-panel input.default,.card-content .green-box input.default {border: 1px solid #3b2e1a;}
    ...
    .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table {border-right: 1px solid #3b2e1a; border-left: 1px solid #3b2e1a; border-bottom: 1px solid #3b2e1a;}
    ...
    .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table tr td {border-right: 1px solid #3b2e1a; border-left: 1px solid #3b2e1a; border-bottom: 1px solid #3b2e1a;}

    .clan-other-recruit-content .green-box, .clan-recruit-content .green-box, .clan-treasury-content .green-box, .clan-manage-content .green-box, .clan-diplomacy-content .green-box, .clan-history-content .chose-show {border: 1px solid #3b2e1a}

    .tip-wrapper {box-shadow: 0px 0px 1px 1px #3b2e1a; color: #f5f5f5;}

    .tip-wrapper.normal-tip .damage,.tip-wrapper.sticky-tip .damage {color: #00ff00;}

    .tip-wrapper .content .info-wrapper .nick {background: #303030; border: 1px solid #3b2e1a;}
    ...
    .tip-wrapper[data-type=t_item] .item-head {background: #101010; border: 1px solid #3b2e1a;}
    .tip-wrapper[data-type=t_item] .item-head .item-builds,.tip-wrapper[data-type=t_item] .item-head .item-type {color: #f5f5f5;}
    .tip-wrapper[data-type=t_item] .item-tip-section {border-bottom: 1px solid #3b2e1a00;}
    ...
    .tip-wrapper[data-item-type=normal],.tip-wrapper[data-item-type=t-norm] {box-shadow: 0px 0px 3px 1px #3b2e1a;}
    </style>`).appendTo('head');
  }
)();