(function() {
    if (getCookie('interface')==='ni') {
        $(`<style> 
            ...
            .cll-alert{border: 1px solid #484848 !important; box-shadow: 0 0 0 1px #484848 !important; background: #101010 !important; color: #ffffff !important;}
            .cll-alert button{background: #101010 !important; border: 1px solid #484848 !important;}
            ...
            .battle-controller .battle-content{border: 1px solid #484848 !important;}
            .battle-controller .battle-content .left-column{border: 1px solid #484848 !important;}
            ...
            .chat-configure-window .chat-option-header {color: #FFFFFF !important; border: 1px solid #484848 !important; background: #101010 !important;}
            ...
            .game-window-positioner .character_wrapper .stats-wrapper {background: #101010 !important; border: 1px solid #484848 !important; }
            ...
            .world-window__info, .info-box, .salvage__info, .enhance__info, .extraction__info{border: 1px solid #484848 !important; background: #484848 !important;}
            .hunting-statistics-table td, .hunting-statistics-table-header td {border: 1px solid #484848 !important; }
            .players-online__item, .server-parameters__item .location-parameters__item{border: 1px solid #484848 !important;}
            ...
            .ni-input input.default {border: 1px solid #484848}
            ...
            .loot-window .items-wrapper .loot-item-wrapper{box-shadow: 0px 0px 0px 1px #484848; background: #101010;}

            .tw-list-item{background: #101010 !important;}
            .border-window.transparent .border-image{box-shadow: 0 0 0 1px #000, 0 0 0 2px #484848, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important; border-radius: 0px;}
