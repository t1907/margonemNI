(function() {
    if (getCookie('interface')==='ni') {
        $(`<style> 
            ...
            .gargonem-window {color: #000000 !important; background: #101010; border-radius: 0px !important; box-shadow: 0 0 0 1px #000, 0 0 0 2px #7800b4, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important;}

            .cll-alert-content{background: #101010 !important;color: #ffffff !important;}
            .cll-alert{border: 1px solid #7800b4 !important; box-shadow: 0 0 0 1px #7800b4 !important; background: #101010 !important; color: #ffffff !important;}
            .cll-alert button{background: #101010 !important; border: 1px solid #7800b4 !important;}
            ...
            .chat-configure-window .chat-option-header {color: #FFFFFF !important; border: 1px solid #7800b4 !important; background: #101010 !important;}
            ...
            .game-window-positioner .character_wrapper .stats-wrapper {background: #101010 !important; border: 1px solid #7800b4 !important; }
            .game-window-positioner .character_wrapper .stats-wrapper .header-title{background: #7800b4 !important; border-bottom: 1px solid #7800b4 !important;}

            .world-window__info, .info-box, .salvage__info, .enhance__info, .extraction__info{border: 1px solid #7800b4 !important; background: #7800b4 !important;}
            .hunting-statistics-table td, .hunting-statistics-table-header td {border: 1px solid #7800b4 !important; }
            .players-online__item, .server-parameters__item .location-parameters__item{border: 1px solid #7800b4 !important;}
            ...
            .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table {border-right: 1px solid #7800b4; border-left: 1px solid #7800b4; border-bottom: 1px solid #7800b4;}
            ...
            .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table tr td {border-right: 1px solid #7800b4; border-left: 1px solid #7800b4; border-bottom: 1px solid #7800b4;}

            .clan-other-recruit-content .green-box, .clan-recruit-content .green-box, .clan-treasury-content .green-box, .clan-manage-content .green-box, .clan-diplomacy-content .green-box, .clan-history-content .chose-show {border: 1px solid #7800b4}
      </style>`).appendTo('body');
  }
}
)();