(function() {
    if (getCookie('interface')==='ni') {
        $(`<style> 
            ...
            .gargonem-window {color: #000000 !important; background: #101010; border-radius: 0px !important; box-shadow: 0 0 0 1px #000, 0 0 0 2px #400080, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important;}

            .cll-alert-content{background: #101010 !important;color: #ffffff !important;}
            .cll-alert{border: 1px solid #400080 !important; box-shadow: 0 0 0 1px #400080 !important; background: #101010 !important; color: #ffffff !important;}
            .cll-alert button{background: #101010 !important; border: 1px solid #400080 !important;}
            ...
            .battle-controller .battle-content{border: 1px solid #400080 !important;}
            .battle-controller .battle-content .left-column{border: 1px solid #400080 !important;}
            ...
            .chat-channel-card-wrapper{border: 1px solid #400080 !important;}
            .new-chat-window .chat-message-wrapper, .chat-input-wrapper .magic-input-wrapper, .chat-input-wrapper .control-wrapper .menu-card, .chat-input-wrapper .control-wrapper .chat-config-wrapper {border: 1px solid #400080 !important;}
            ...
            .chat-configure-window .chat-option-header {color: #FFFFFF !important; border: 1px solid #400080 !important; background: #101010 !important;}
            ...
            .game-window-positioner .character_wrapper .stats-wrapper {background: #101010 !important; border: 1px solid #400080 !important; }
            .game-window-positioner .character_wrapper .stats-wrapper .header-title{background: #400080 !important; border-bottom: 1px solid #400080 !important;}

            .world-window__info, .info-box, .salvage__info, .enhance__info, .extraction__info{border: 1px solid #400080 !important; background: #400080 !important;}
            .hunting-statistics-table td, .hunting-statistics-table-header td {border: 1px solid #400080 !important; }
            .players-online__item, .server-parameters__item .location-parameters__item{border: 1px solid #400080 !important;}
            ...
            .ni-input input.default {border: 1px solid #400080}
            ...
            .loot-window .items-wrapper .loot-item-wrapper{box-shadow: 0px 0px 0px 1px #400080; background: #101010;}

            .tw-list-item{background: #101010 !important;}
            .border-window.transparent .border-image{box-shadow: 0 0 0 1px #000, 0 0 0 2px #400080, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important; border-radius: 0px;}
            ...
            .button, .widget-button, .button.green, .widget-button.green {background-image: linear-gradient(to top, #101010, #101010)!important;box-shadow: inset 0 0 1px 1px #400080, inset 0 0 0 3px #101010!important;}
            ...
            .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table {border-right: 1px solid #400080; border-left: 1px solid #400080; border-bottom: 1px solid #400080;}
            ...
            .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table tr td {border-right: 1px solid #400080; border-left: 1px solid #400080; border-bottom: 1px solid #400080;}

            .clan-other-recruit-content .green-box, .clan-recruit-content .green-box, .clan-treasury-content .green-box, .clan-manage-content .green-box, .clan-diplomacy-content .green-box, .clan-history-content .chose-show {border: 1px solid #400080}
      </style>`).appendTo('body');
  }
}
)();