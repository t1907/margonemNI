...
.button,.widget-button{
    border-radius:8px;
    background-color:#1f2b34; /* głęboki granatowy */
    box-shadow:inset 0 0 0 1px #a3aebd,inset 0 0 0 3px #2c3e50; /* chłodne akcenty szarości */
    border:solid 1px #2c3e50;
    background-image:linear-gradient(to top,#1f2b34,#4c637b); /* subtelna gradacja błękitu */
    color:#d4d9e1; /* jasny szary, niemal biały */
}
.button::before,.widget-button::before{
    box-shadow:inset 0 0 1px 1px rgba(149,168,186,.65); /* szaro-niebieskie akcenty */
    border-radius:4px;
}
.button.active::before,.widget-button.active::before{
    box-shadow:inset 0 0 1px 1px rgba(38,56,74,.65); /* ciemniejszy akcent na aktywnych */
}
.button.window-is-open::before,.widget-button.window-is-open::before{
    background-color:#2e3b47; /* ciemniejszy, zimny odcień */
}

.button.red,.widget-button.red{
    background-image:linear-gradient(to top,#3c4b5c,#8b96a0); /* granatowo-szare akcenty */
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.red::before,.widget-button.red::before{
    box-shadow:inset 0 0 1px 1px rgba(149,168,186,.65);
    border-radius:4px;
}
.button.red.active::before,.widget-button.red.active::before{
    box-shadow:inset 0 0 1px 1px rgba(38,56,74,.65);
}
...
.button.blue,.widget-button.blue{
    background-image:linear-gradient(to top,#2e3e50,#5b6d7e); /* zimny niebieski z odcieniem szarości */
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.blue::before,.widget-button.blue::before{
    box-shadow:inset 0 0 1px 1px rgba(97,119,140,.65); /* chłodny błękit */
    border-radius:4px;
}
.button.blue.active::before,.widget-button.blue.active::before{
    box-shadow:inset 0 0 1px 1px rgba(31,46,61,.65); /* ciemniejszy akcent */
}
...
.button.green,.widget-button.green{
    background-image:linear-gradient(to top,#2c3f38,#4c6b53); /* ciemna zieleń inspirowana lasami skandynawskimi */
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.green::before,.widget-button.green::before{
    box-shadow:inset 0 0 1px 1px rgba(98,137,112,.65); /* zielenie w odcieniu mchu */
    border-radius:4px;
}
.button.green.active::before,.widget-button.green.active::before{
    box-shadow:inset 0 0 1px 1px rgba(25,41,31,.65); /* ciemniejsze akcenty */
}
...
.button.purple,.button.violet,.widget-button.purple,.widget-button.violet{
    background-image:linear-gradient(to top,#3c3f52,#676f8e); /* fioletowo-szary odcień */
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.purple::before,.button.violet::before,.widget-button.purple::before,.widget-button.violet::before{
    box-shadow:inset 0 0 1px 1px rgba(122,143,175,.65); /* jaśniejsze fioletowe akcenty */
    border-radius:4px;
}
.button.purple.active::before,.button.violet.active::before,.widget-button.purple.active::before,.widget-button.violet.active::before{
    box-shadow:inset 0 0 1px 1px rgba(55,63,84,.65);
}
...
.button.orange,.widget-button.orange{
    background-image:linear-gradient(to top,#4a4c34,#7a8364); /* ziemiste odcienie pomarańczowego */
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.orange::before,.widget-button.orange::before{
    box-shadow:inset 0 0 1px 1px rgba(182,194,173,.65); /* delikatny pomarańczowo-zielony akcent */
    border-radius:4px;
}
.button.orange.active::before,.widget-button.orange.active::before{
    box-shadow:inset 0 0 1px 1px rgba(46,55,44,.65);
}
...
.button.transparent,.widget-button.transparent{
    background-image:linear-gradient(to top,#1f2b34,#4c637b); /* przezroczystość z nordyckim akcentem błękitu */
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.transparent::before,.widget-button.transparent::before{
    box-shadow:inset 0 0 1px 1px rgba(149,168,186,.65); /* przezroczysty efekt z chłodnymi akcentami */
    border-radius:4px;
}
...
.button.blink-violet,.widget-button.blink-violet{
    background-image:linear-gradient(to top,#3c3f52,#676f8e);
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.blink-violet::before,.widget-button.blink-violet::before{
    box-shadow:inset 0 0 1px 1px rgba(122,143,175,.65);
    border-radius:4px;
}
...
.button.pressed,.widget-button.pressed{
    background-image:linear-gradient(to top,#1f2b34,#2e3b47); /* ciemniejszy efekt */
    box-shadow:inset 0 0 1px 1px #a3aebd,inset 0 0 0 3px #2c3e50;
}
.button.pressed::before,.widget-button.pressed::before{
    box-shadow:inset 0 0 1px 1px rgba(89,96,111,.65);
    border-radius:4px;
}
.button.pressed.active::before,.widget-button.pressed.active::before{
    box-shadow:inset 0 0 1px 1px rgba(31,41,50,.65);
}
