(function() {
    $(`<style> 
       ...
       .popup-menu .menu-item {background: #101010; border: 1px solid #640064; border-radius: 1px;}
       .popup-menu .menu-item:hover:not(.label):not(.disabled):not(.cooldown-disabled):not(.one-step-skill-menu) {border: 1px solid #40ff40; background-color: #202020;}
