(function() {
    $(`<style> 
       ...
       .popup-menu .menu-item {background: #808080; border: 1px solid #202020; border-radius: 1px;}
       ...
       .popup-menu .menu-item.one-step-skill-menu:not(.disabled):hover {border: 1px solid #202020; background-color: #101010;}
