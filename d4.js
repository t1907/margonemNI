(function() {
    $(`<style> 
       ...
       .popup-menu{border-radius: 1px; background-color: #101010; box-shadow: 0 0 0 1px #640064;}
       ...
       .popup-menu .menu-item.one-step-skill-menu:not(.disabled) {border: 1px solid #202020; background-color: #505050;}
       .popup-menu .menu-item.one-step-skill-menu:not(.disabled):hover {border: 1px solid #202020; background-color: #006400;}
