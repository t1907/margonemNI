(function() {
  ...
  .gargonem-window {color: #000000 !important; background: #121620; border-radius:0!important; box-shadow: 0 0 0 1px #000, 0 0 0 2px #9e8356, 0 0 0 3px #000000, 2px 2px 3px 3px #000 !important;}
  
  .cll-alert-content{background: #121620 !important;color: #f5f5f5 !important;}
  .cll-alert{border: 1px solid #9e8356 !important; box-shadow: 0 0 0 1px #9e8356; !important; background: #121620 !important; color: #f5f5f5 !important;}
  .cll-alert button{background: #121620 !important; border: 1px solid #9e8356 !important; box-shadow: 0 0 0 1px #121620 !important;}
...
.interface-element-grid-border {
  outline: 1px solid #121620; /* Głęboki morski granat */
  box-shadow: 0 0 0 1px #9e8356; /* Złoty akcent */
}

.interface-element-border-window-header-middle {
  box-shadow: inset 0 1px 0 0 #9e8356; /* Subtelny złoty efekt */
  background: #121620; /* Mroczny błękit inspirowany Morzem Egejskim */
}
  ...
  .interface-element-green-box-background{background:#121620}
  .interface-element-green-box-background-stretch{background:#121620}
  
  .interface-element-background-color-1, .interface-element-background-color-2, .interface-element-background-color-3, .interface-element-background-color-4{background:#121620}
  
  .interface-element-box-shadow-1{box-shadow:inset 0 0 5px 0 #9e8356}
  .interface-element-box-shadow-2{box-shadow: 0 0 0 1px #9e8356;}
  
  .interface-element-one-item-slot-2{border: 1px solid #9e8356;outline: 2px solid #121620; background: #121620; box-shadow: inset 2px 0 15px 1px #000;}
  ...
  .interface-element-middle-1-background, .interface-element-middle-2-background, .interface-element-middle-3-background, .interface-element-middle-4-background{
    border-image:url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/greek/middle_graphics.png) 0 11 fill round;background:#121620
  }
  ...
  .interface-element-table-td-3-border{border:1px solid #9e8356}
  .interface-element-table-header-3-border{border:1px solid #9e8356}
  .interface-element-table-header-3-background{background:#121620}
  .interface-element-table-3{color:#f0f0f0}
  .interface-element-table-3 .table-header-tr td{border:1px solid #9e8356;background:#121620}
  .interface-element-table-3 tr:nth-of-type(2n+1){background: #121620;}
  .interface-element-table-3 td{border:1px solid #9e8356}
  ...
  .interface-element-line-1-background{background:#121620}
  ...
  .auction-off-item-panel input.default,.auction-window input.default{background:url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/greek/width-card-button-active.png) no-repeat;background-size:100% 100%;border:1px solid #9e8356;color:#f0f0f0}
  ...
  .border-window .content {background: #121620;}
  ...
  .trade-window .content .hero-show-item, .trade-window .content .other-watch-item {background: #121620;}
  ...
  .tw-list-item{background: #121620 !important;}
  .border-window.transparent .border-image, .dialogue-window .border-image{box-shadow: 0 0 0 1px #9e8356;; border-radius: 0;}
  .border-window.transparent .search-wrapper{border-top:1px solid rgba(191, 167, 122,.5)}
  
  .border-window.mAlert .paper-background, .border-window.mAlert-mobile-layer .paper-background {background: #121620;}
  .auction-window .main-column-auction {background: #121620;}
  .auction-window .main-column-auction .auction-search-item{border:1px solid #9e8356}
...
.drop-down-menu-section .type-header{background:url(https://raw.githubusercontent.com/t1907/margonemNI/refs/heads/main/greek/header_left.png)}
  ...
  .mails-window .mail-column .scroll-wrapper .scroll-pane .one-mail-wraper {background: #121620;}
  ...
  .shop-wrapper .shop-background .paper-1,.shop-wrapper .shop-background .paper-2 {background: #121620; box-shadow: inset 0 0 5px 0 #9e8356;}
  ...
  .left-grouped-list-and-right-description-window .left-column .scroll-wrapper{border: 1px solid #9e8356}
  
  .world-window__info, .info-box, .salvage__info, .enhance__info, .extraction__info{border: 1px solid #9e8356 !important; background: #121620 !important; color: #c2b59b;}
  .players-online__item, .server-parameters__item .location-parameters__item{border: 1px solid #9e8356 !important; background: #121620;}
  .players-online__item:hover{background:rgba(191, 167, 122,.5)}
  
  .location-parameters__item,.server-parameters__item{border:1px solid #9e8356;color: #c2b59b;;}
  .location-parameters__item:nth-child(odd),.server-parameters__item:nth-child(odd){background:rgba(191, 167, 122,.5)}
  .location-parameters__item-value,.server-parameters__item-value{border-left:1px solid #9e8356;}
  .location-parameters__item-value a,.server-parameters__item-value a{color: #c2b59b; !important;}

  .hunting-statistics-table td, .hunting-statistics-table-header td {border: 1px solid #9e8356 !important; background: #121620;}
  .hunting-statistics-table th,.hunting-statistics-table-header th{border:1px solid #9e8356;background:rgb(13, 27, 42);}
  .hunting-statistics-table th.can-hover:hover,.hunting-statistics-table-header th.can-hover:hover{background:rgb(26, 54, 82);}
  .hunting-statistics{color: #c2b59b;}
  .hunting-statistics-item{color: #c2b59b;}
  ...
  .crafting-reagent{background: #121620; border: 1px solid #9e8356}
  .salvage__label, .extraction__label, .enhance__label{border:1px solid #9e8356; box-shadow:none; color: #c2b59b;; background: #121620}
  ...
  .game-window-positioner .character_wrapper .stats-wrapper .header-title{background: #9e8356 !important; border-bottom: 1px solid #9e8356 !important;}
  .game-window-positioner .character_wrapper .stats-wrapper .interface-element-active-card-background-stretch{left: 0; right: 0;}
  .game-window-positioner .inventory_wrapper .inventory-grid-bg {border: 1px solid #121620;}

  .extended-stats .scroll-pane h3{border-bottom:1px solid #9e8356;color: #1a3652}
  .extended-stats .scroll-pane .stat-group h4{color: #1a3652}
  
  .chat-channel-card-wrapper{border: 1px solid #9e8356 !important;}
  .new-chat-window .chat-message-wrapper, .chat-input-wrapper .magic-input-wrapper, 
  .chat-input-wrapper .control-wrapper .menu-card, .chat-input-wrapper .control-wrapper .chat-config-wrapper {border: 1px solid #9e8356 !important; box-shadow: none;}
  .chat-input-wrapper {background: #121620 !important;}
  .new-chat-window {background: #121620 !important;}
.chat-configure-window .chat-option-header {
    color: #c2b59b; !important; /* Złoty, nawiązujący do starożytnego Egiptu */
    border: 1px solid #9e8356 !important; /* Piaskowy odcień, pasujący do obramowań */
  ...
  .table-with-static-header .scroll-table-plug{background: #1a3652; border:1px solid #9e8356;}
  ...
  .MBEditor .skills-list .single-skill-row {border-bottom: 1px solid #9e8356}
  .MBEditor .skills-list .single-skill-row.usable {border-color: #9e8356}
  .MBEditor .skills-list .single-skill-row.usable:nth-child(odd) {background: rgba(26, 54, 82, 0.25)} 
  .MBEditor .skills-list .single-skill-row.usable .number {border-color: #9e8356}
  .MBEditor .skills-list .single-skill-row.usable:hover {background: #070e15}
  .MBEditor .skills-list .single-skill-row .number {border-right: 1px solid #9e8356} 
  ...
  .loot-window .items-wrapper .loot-item-wrapper{box-shadow:2px 2px 2px 0 rgba(0,0,0,.6);border:1px solid #9e8356}
  .loot-window .items-wrapper .loot-item-wrapper.yours{border:solid 1px #ffdd00}
  .loot-window .items-wrapper .loot-item-wrapper .slot{border:1px solid #9e8356}
  .loot-window .items-wrapper .loot-item-wrapper .text-info{color: #f5f5f5;border-top:1px solid #9e8356;border-bottom:1px solid #9e8356} 
  ...
  .ni-input input.default {border: 1px solid #9e8356;border-radius: 0;background: #1a3652;box-shadow: inset 0 0 1px 1px rgb(26, 54, 82);color: #f5f5f5;}
...
.popup-menu {
    box-shadow: 0 0 0 1px #1a3652 inset, 0 0 0 1px #9e8356b0, 0 0 0 2px #1a3652;
    border-radius: 0;
...
.button.red,.widget-button.red{
  ...
  filter: contrast(1.1) brightness(0.9);
  opacity: 0.95;
    box-shadow:inset 0 0 1px 1px #4a1e1e,inset 0 0 0 3px #121620
}
...
.button.blink-violet::before,.widget-button.blink-violet::before{
    box-shadow:inset 0 0 1px 1px #121620;
    border-radius:0;
}
...
.widget-button .widget-blink{display: none !important;}
  ...
  .card-content .clan-list-find-panel input.default,.card-content .green-box input.default {border: 1px solid #9e8356;}
  ...
  .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table {border-right: 1px solid #9e8356; border-left: 1px solid #9e8356; border-bottom: 1px solid #9e8356;}
  ...
  .card-content .clan-treasury-content:not(.clan-official-page-content):not(.clan-priv-page-content) table tr td {border-right: 1px solid #9e8356; border-left: 1px solid #9e8356; border-bottom: 1px solid #9e8356;}
  
  .clan-other-recruit-content .green-box, .clan-recruit-content .green-box, .clan-treasury-content .green-box, .clan-manage-content .green-box, .clan-diplomacy-content .green-box, .clan-history-content .chose-show {border: 1px solid #9e8356}
